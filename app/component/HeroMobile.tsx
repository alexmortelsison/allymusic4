...
export default function HeroMobile() {
  return (
    <div className="font-sans">
      ...
      />
      <div className="max-w-7xl mx-auto md:ml-8 md:pt-54">
        <div className="flex flex-col justify-start mt-38 md:pt-16 pl-2">
          ...
          <p className="bg-pink-700 w-1/3 py-2 px-8 text-center rounded-3xl md:text-2xl md:py-4 md:w-1/3 font-bold mt-8 text-nowrap">
            Sold out
          </p>
        </div>
      </div>
